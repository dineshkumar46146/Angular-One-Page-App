...
@Injectable()
export class AppMockBackService extends AppService {
    constructor()   {
        super();
    }
...
const PRODUCT_LIST = [
    new Product({ imgUrl:'img/img1.jpg', code: 'PROD1 -1', name: 'Product -1 1', description:'Product Description   1'}),
    new Product({ imgUrl:'img/img2.jpg', code: 'PROD2 -1', name: 'Product -1 2', description:'Product Description   2'}),
    new Product({ imgUrl:'img/img3.jpg', code: 'PROD3 -1', name: 'Product -1 3', description:'Product Description   3'}),
    new Product({ imgUrl:'img/img4.jpg', code: 'PROD4 -1', name: 'Product -1 4', description:'Product Description   4'}),
    new Product({ imgUrl:'img/img5.jpg', code: 'PROD5 -1', name: 'Product -1 5', description:'Product Description   5'}),
    new Product({ imgUrl:'img/img6.jpg', code: 'PROD6 -1', name: 'Product -1 6', description:'Product Description   6'}),
    new Product({ imgUrl:'img/img7.jpg', code: 'PROD7 -1', name: 'Product -1 7', description:'Product Description   7'}),
    new Product({ imgUrl:'img/img8.jpg', code: 'PROD8 -1', name: 'Product -1 8', description:'Product Description   8'}),
    new Product({ imgUrl:'img/img9.jpg', code: 'PROD9 -1', name: 'Product -1 9', description:'Product Description   9'}),
    new Product({ imgUrl:'img/img10.jpg', code: 'PROD10 -1', name: 'Product - 1 10', description:'Product Description   10'})
